...
export default {
  methods: {
    ...
    tl.to(
      '.second',
      { opacity: 1, scale: 1.5, duration: 0.5, ease: 'bounce.out' },
      '<.3' // delay after the previous element
    )
    tl.to(
      '.third',
      { opacity: 1, scale: 2, duration: 0.5, ease: 'bounce.out' },
      '<.3'
    )
    tl.to(
      '.fourth',
      { opacity: 1, scale: 2.2, duration: 0.5, ease: 'bounce.out' },
      '<.3'
    )
    return tl
  },
